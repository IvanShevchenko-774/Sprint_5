...
class TestLogout:
    def test_logout_success(self, driver):
        ...
        WebDriverWait(driver, 10).until(expected_conditions.element_to_be_clickable(LOGOUT_BUTTON)).click()
        assert WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located(LOGIN_AND_SIGNUP_BUTTON)).is_displayed()